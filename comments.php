...
<div id="comments" class="comments-area space-y-8 mt-10">
	...
	<?php if ( have_comments() ) : ?>
		...
		<?php if ( ! comments_open() ) : ?>
			<p class="no-comments text-gray-500 text-sm"><?php esc_html_e( 'Les commentaires sont fermés.', 'photovault' ); ?></p>
		<?php endif; ?>

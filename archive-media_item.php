	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<header class="mb-14 text-center sm:text-left flex flex-col sm:flex-row justify-between items-center gap-6 border-b border-gray-900 pb-10">
			<div>
				...
				<p class="text-gray-300 mt-2 text-sm sm:text-base font-medium max-w-xl">Explorez des photographies exclusives et des projets captivants protégés par PhotoVault.</p>
			</div>
			<div>
				...
				<div class="glass-effect p-6 rounded-3xl border border-gray-800/80 space-y-6 sticky top-28 shadow-xl">
					...
					<form id="filters-form" class="space-y-5" onsubmit="return false;">
						...
						<div class="space-y-1.5">
							<label class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Recherche</label>
							<div class="relative">
						...
						<!-- Dossier -->
						<div class="space-y-1.5">
							<label class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Dossier / Projet</label>
						...
						<!-- Catégorie -->
						<div class="space-y-1.5">
							<label class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Catégorie</label>
						...
						<!-- Protection -->
						<div class="space-y-1.5">
							<label class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Protection</label>
						...
						<!-- Tri -->
						<div class="space-y-1.5">
							<label class="block text-xs font-bold text-gray-300 uppercase tracking-wider">Trier par</label>
				...
				<div id="media-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 transition-all duration-300">
					...
					<?php else : ?>
						<div class="col-span-full text-center py-24 glass-effect rounded-3xl border border-gray-800">
							...
							<p class="text-gray-300 font-semibold text-lg">Aucun média public disponible</p>
				...
				if (res.success && res.data.length > 0) {
					...
					grid.innerHTML = `
						<div class="col-span-full text-center py-20 glass-effect rounded-3xl border border-gray-800/80">
							...
							<p class="text-gray-300 font-medium">Aucun média ne correspond à vos filtres.</p>
						</div>
					`;
				}
			})

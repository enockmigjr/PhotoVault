...
<div class="flex min-h-screen bg-[#0b0f19] font-sans">
	<!-- Barre latérale -->
	<?php get_template_part( 'templates/dashboard-sidebar' ); ?>

	<!-- Contenu Principal -->
	<main class="flex-1 p-8 sm:p-12 overflow-y-auto">
		<div class="max-w-6xl mx-auto space-y-12">
			...
			<!-- Grille de statistiques analytique premium -->
			...
			<!-- Dernières importations du système -->
			<div class="glass-effect p-8 rounded-3xl shadow-xl border border-gray-800/80">

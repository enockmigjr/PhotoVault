...
<main class="min-h-screen bg-[#0d0c0b] text-gray-100">
	<header class="border-b border-white/10 py-20 sm:py-28 lg:py-32">
		<div class="mx-auto grid max-w-[90rem] gap-10 px-5 sm:px-8 lg:grid-cols-12 lg:px-12">
			<div class="lg:col-span-8">
				<p class="text-xs font-extrabold uppercase text-indigo-400"><?php esc_html_e( 'Prestations / Devis', 'photovault' ); ?></p>
			...
			<div class="self-end lg:col-span-4">
				...
				<a href="<?php echo esc_url( add_query_arg( 'type', 'custom', home_url( '/booking/' ) ) ); ?>" class="mt-7 inline-flex min-h-12 items-center bg-white px-6 text-sm font-extrabold text-black transition hover:bg-indigo-400"><?php esc_html_e( 'Présenter mon projet', 'photovault' ); ?></a>
			</div>
		</div>
	</header>
		...
		<div class="divide-y divide-white/10 border-b border-white/10">
			<?php foreach ( $services as $service ) : ?>
				<article class="grid gap-8 py-10 lg:grid-cols-12 lg:py-14">
					<p class="text-sm font-bold text-indigo-400 lg:col-span-1"><?php echo esc_html( $service['number'] ); ?></p>
	...
	<section class="border-y border-white/10 bg-[#11100e] py-16 lg:py-20" aria-labelledby="estimate-title">
		<div class="mx-auto grid max-w-[90rem] gap-12 px-5 sm:px-8 lg:grid-cols-12 lg:px-12">
			<div class="lg:col-span-5"><p class="text-xs font-bold uppercase text-indigo-400"><?php esc_html_e( 'Un devis lisible', 'photovault' ); ?></p><h2 id="estimate-title" class="mt-4 font-serif text-4xl text-white sm:text-5xl"><?php esc_html_e( 'Ce qui sera défini avant confirmation.', 'photovault' ); ?></h2></div>
	...
	<section class="px-5 py-20 text-center sm:px-8 lg:py-28">
		...
		<a href="<?php echo esc_url( home_url( '/booking/' ) ); ?>" class="mt-9 inline-flex min-h-12 items-center bg-white px-7 text-sm font-extrabold text-black transition hover:bg-indigo-400"><?php esc_html_e( 'Préparer ma demande', 'photovault' ); ?></a>
	</section>
</main>

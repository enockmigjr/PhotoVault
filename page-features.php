...
<div class="py-20 bg-[#0d0c0b] min-h-screen text-gray-200">
	<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
		<header class="max-w-3xl space-y-4">
			...
			<p class="text-gray-300 text-lg leading-relaxed">PhotoVault organise vos collections, protege les apercus publics et reserve les fichiers originaux aux telechargements autorises.</p>
		</header>
		...
		<section class="grid grid-cols-1 md:grid-cols-3 gap-6">
			<div class="glass-effect p-7 rounded-3xl border border-gray-800/80 space-y-4">
				...
				<p class="text-sm text-gray-300 leading-relaxed">Les pages de galerie affichent des miniatures adaptees a la grille. Les originaux restent hors du navigateur pendant la navigation.</p>
			</div>
			...
			<div class="glass-effect p-7 rounded-3xl border border-gray-800/80 space-y-4">
				...
				<p class="text-sm text-gray-300 leading-relaxed">Les medias proteges passent par un proxy qui controle les droits, applique le filigrane serveur et bloque le telechargement non autorise.</p>
			</div>
			...
			<div class="glass-effect p-7 rounded-3xl border border-gray-800/80 space-y-4">
				...
				<p class="text-sm text-gray-300 leading-relaxed">Le fichier original n'est servi qu'au moment du telechargement, apres verification de la session et du statut de protection.</p>
			</div>
		</section>
		...
		<section class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start border-t border-gray-900 pt-14">
			<div class="space-y-4">
				...
				<p class="text-gray-300 leading-relaxed">Importez vos images, classez-les par dossier client ou categorie, choisissez le niveau de protection, puis laissez PhotoVault presenter les apercus et gerer les droits d'acces.</p>
			</div>
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
				<div class="p-5 rounded-2xl bg-gray-950/40 border border-gray-800"><strong class="block text-white mb-1">01. Import</strong><span class="text-gray-300">Ajout depuis l'admin WordPress.</span></div>
				<div class="p-5 rounded-2xl bg-gray-950/40 border border-gray-800"><strong class="block text-white mb-1">02. Classement</strong><span class="text-gray-300">Dossiers projets et categories.</span></div>
				<div class="p-5 rounded-2xl bg-gray-950/40 border border-gray-800"><strong class="block text-white mb-1">03. Consultation</strong><span class="text-gray-300">Apercus rapides et filigranes.</span></div>
				<div class="p-5 rounded-2xl bg-gray-950/40 border border-gray-800"><strong class="block text-white mb-1">04. Livraison</strong><span class="text-gray-300">Telechargement HD autorise.</span></div>
			</div>
		</section>
	</div>
</div>

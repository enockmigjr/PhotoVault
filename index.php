<?php
/**
 * Template principal par défaut (index.php) de PhotoVault.
 *
 * @package PhotoVault
 */
...
<div class="py-12 bg-[#0d0c0b] min-h-screen">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<header class="mb-10 pb-6 border-b border-gray-900">
			<h1 class="text-4xl font-extrabold text-white">Actualités & Blog</h1>
			<p class="text-gray-300 mt-1">Suivez les nouveautés de PhotoVault.</p>
		</header>
		...
		<?php else : ?>
			<div class="text-center py-20 glass-effect rounded-2xl">
				<p class="text-gray-300">Aucun article disponible pour le moment.</p>
			</div>
		<?php endif; ?>
	</div>
</div>

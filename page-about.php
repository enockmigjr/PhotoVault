...
<main class="min-h-screen bg-[#0d0c0b] text-gray-100">
	<header class="border-b border-white/10 py-20 sm:py-28">
		<div class="mx-auto grid max-w-[90rem] gap-10 px-5 sm:px-8 lg:grid-cols-12 lg:px-12">
			<div class="lg:col-span-8">
				...
				<h1 class="mt-5 max-w-5xl font-serif text-4xl leading-[1.04] text-white sm:text-5xl"><?php esc_html_e( 'Photographier ce que le temps laisse derrière lui.', 'photovault' ); ?></h1>
			</div>
	...
	<section class="mx-auto grid max-w-[90rem] items-end gap-10 px-5 py-20 sm:px-8 lg:grid-cols-12 lg:px-12 lg:py-28">
		<div class="lg:col-span-8"><p class="text-xs font-extrabold uppercase text-gray-500"><?php esc_html_e( 'Continuer', 'photovault' ); ?></p><h2 class="mt-5 font-serif text-4xl leading-tight text-white sm:text-5xl"><?php esc_html_e( 'Regarder les archives ou construire les prochaines images.', 'photovault' ); ?></h2></div>
